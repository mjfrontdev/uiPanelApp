  ...
  return (
    <div className="bg-white rounded-xl shadow-sm p-4 sm:p-6">
      <div className="flex items-center justify-between mb-4 sm:mb-6">
        <h2 className="text-lg sm:text-xl font-semibold text-gray-800">Portfolio</h2>
      ...
      <div className="mb-4">
        <div className="flex flex-col sm:flex-row sm:items-baseline gap-2 sm:gap-4 mb-2">
          <span className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900">$ 17 643.41</span>
          <div className="bg-black text-white px-3 py-1 rounded-full flex items-center gap-2 text-xs sm:text-sm w-fit">
            <span>$27 483.00</span>
            <FiMoreVertical className="text-xs" />
          </div>
        </div>
        <p className="text-gray-500 text-xs sm:text-sm">Portfolio balance</p>
      </div>
